...
const customer_global_search_query_1 = __importDefault(require("../queries/customer-global-search-query"));
const customer_column_search_query_1 = __importDefault(require("../queries/customer-column-search.query"));
...
function filterAndPaginate(query) {
    ...
    const limit = perPage;
    const queries = (0, lodash_1.size)(query.q) >= constants_1.Q_MINIMUM_SIZE ? (0, customer_global_search_query_1.default)(query) : {};
    ...
    return models_1.Customer.findAndCountAll({
        ...
        const result = (0, paginator_result_1.paginate)(rowsAndCounts, perPage, page);
...
function savePdf(base64) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield parser.parse(data.data);
    });
}
